    ...
    <PageLayout>
      ...
      <main className="flex-1 relative">
        ...
        <section className="relative z-10 py-16 bg-gray-50">
          <div className="container max-w-6xl mx-auto px-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-12 leading-tight text-gray-900 text-center">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="md:w-1/3">
                  <div className="w-full h-64 bg-gray-200 rounded-lg shadow-lg flex items-center justify-center">
                    <p className="text-gray-500 text-center">Image placeholder<br/>for wardrobe scenario</p>
                  </div>
                </div>
                <div className="md:w-2/3">
                  <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
