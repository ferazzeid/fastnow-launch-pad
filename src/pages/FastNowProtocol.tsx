                ...
                <div className="bg-card rounded-lg shadow-soft border border-border overflow-hidden">
                  {phaseContent.phase1.image && (
                    <div className="w-full h-48 overflow-hidden">
                      <img 
                        ...
                        alt={`Phase 1 - ${phaseContent.phase1.title}`}
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-foreground">{phaseContent.phase1.title}</h3>
                    </div>
                    
                    <div className="space-y-4">
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <h4 className="text-sm font-semibold text-foreground mb-1">Duration</h4>
                        <p className="text-sm text-muted-foreground">{phaseContent.phase1.duration}</p>
                      </div>
                      
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <h4 className="text-sm font-semibold text-foreground mb-1">Purpose</h4>
                        <p className="text-sm text-muted-foreground">{phaseContent.phase1.purpose}</p>
                      </div>
                      
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <h4 className="text-sm font-semibold text-foreground mb-1">Instructions</h4>
                        <p className="text-sm text-muted-foreground">{phaseContent.phase1.instructions}</p>
                      </div>
                      
                      {phaseContent.phase1.details && (
                        <div className="bg-muted/50 p-3 rounded-lg">
                ...
                <div className="bg-card rounded-lg shadow-soft border border-border overflow-hidden">
                  {phaseContent.phase2.image && (
                    <div className="w-full h-48 overflow-hidden">
                      <img 
                        ...
                        alt={`Phase 2 - ${phaseContent.phase2.title}`}
                        className="w-full h-full object-cover"
                      />
                    </div>
                  )}
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-foreground">{phaseContent.phase2.title}</h3>
                    </div>
                    
                    <div className="space-y-4">
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <h4 className="text-sm font-semibold text-foreground mb-1">Duration</h4>
                        <p className="text-sm text-muted-foreground">{phaseContent.phase2.duration}</p>
                      </div>
                      
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <h4 className="text-sm font-semibold text-foreground mb-1">Calorie Cap</h4>
                        <p className="text-sm text-muted-foreground">{phaseContent.phase2.calorieCap}</p>
                      </div>
                      
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <h4 className="text-sm font-semibold text-foreground mb-1">Carb Limit</h4>
                        <p className="text-sm text-muted-foreground">{phaseContent.phase2.carbCap}</p>
                      </div>
                      
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <h4 className="text-sm font-semibold text-foreground mb-1">What to Eat</h4>
                        <div className="text-sm text-muted-foreground">
                          {phaseContent.phase2.whatToEat && phaseContent.phase2.whatToEat.split('\n').map((line: string, index: number) => (
                ...
                <div className="bg-card rounded-lg shadow-soft border border-border overflow-hidden">
                  {phaseContent.phase3.image && (
                    <div className="w-full h-48 overflow-hidden">
                      <img 
                        ...
                        alt={`Phase 3 - ${phaseContent.phase3.title}`}
                        className="w-full h-full object-cover"
                      />
                    </div>
                  )}
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-foreground">{phaseContent.phase3.title}</h3>
                    </div>
                    
                    <div className="space-y-4">
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <h4 className="text-sm font-semibold text-foreground mb-1">Rule</h4>
                        <p className="text-sm text-muted-foreground">{phaseContent.phase3.rule}</p>
                      </div>
                      
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <h4 className="text-sm font-semibold text-foreground mb-1">Why</h4>
                        <p className="text-sm text-muted-foreground">{phaseContent.phase3.why}</p>
                      </div>
