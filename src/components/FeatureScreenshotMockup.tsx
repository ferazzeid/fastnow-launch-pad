        ...
        <div className="bg-black rounded-[1.5rem] p-1">
          <div className="relative bg-white rounded-[1.25rem] overflow-hidden aspect-[9/19.5]">
            ...
            {imageUrl && !imageError ? (
              ...
              <div className={`w-full h-full flex items-center justify-center ${featureKey === 'fasting-timer' ? 'bg-muted/30' : 'bg-gradient-to-br from-primary/20 to-primary/10'}`}>
                {featureKey === 'fasting-timer' ? (
                  <div className="text-center text-muted-foreground">
                    <div className="w-16 h-16 bg-muted rounded-full mx-auto mb-4 flex items-center justify-center opacity-50">
                      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <p className="text-sm opacity-50">No Screenshot</p>
                  </div>
                ) : (
                  <div className="text-center text-muted-foreground">
